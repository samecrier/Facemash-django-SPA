...
from frontend.views.tournaments.views import TournamentView, WinnerTournamentView, StageTournamentView, HomeTournamentView, CreateTournamentView, MatchupTournamentView
